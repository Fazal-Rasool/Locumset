...
public class RA_MyJobs extends RecyclerView.Adapter<RA_MyJobs.ViewHolder> {
    ...
    public RA_MyJobs(Activity activity,
...
//
//        String f_Day = (String) DateFormat.format("EE", fromDate); // Thursday
//        String f_dayNum = (String) DateFormat.format("dd", fromDate); // 20
//        String f_mnth = (String) DateFormat.format("MMM", fromDate); // Jun
//
//        String t_Day = (String) DateFormat.format("EE", toDate); // Thursday
//        String t_dayNum = (String) DateFormat.format("dd", toDate); // 20
//        String t_mnth = (String) DateFormat.format("MMM", toDate); // Jun
//
